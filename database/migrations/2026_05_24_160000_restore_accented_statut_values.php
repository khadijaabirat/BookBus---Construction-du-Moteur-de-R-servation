    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement('
                ...
                SELECT "id","reference","date_reservation",
                CASE WHEN "statut"=\'Confirme\' THEN \'Confirmé\'
                     WHEN "statut"=\'Annule\' THEN \'Annulé\'
                     WHEN "statut"=\'Paye\' THEN \'Payé\'
                     ELSE "statut" END,
                "siege_numero","user_id","passenger_id","segment_id",
        ...
        // MySQL: nothing to do, values are already correct
    }
